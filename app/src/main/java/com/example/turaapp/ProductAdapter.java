...
import static com.example.turaapp.CategoryAdapter.categoryIcons;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String category = product.description;
        Integer iconRes = categoryIcons.get(category);
        if (iconRes != null) {
            holder.productImage.setImageResource(iconRes);
        } else {
            holder.productImage.setImageResource(R.drawable.tura);
        }
